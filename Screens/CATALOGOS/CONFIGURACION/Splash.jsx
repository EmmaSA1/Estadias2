...
export default function Splash() {
  ...
  useEffect(() => {
    const redirect = setTimeout(() => {
      navigation.replace('HomeCatalogoConf');
    }, 1500);
  ...
  const getMessage = (action) => {
    ...
    switch (action) {
      case 13:
        return 'Configuración Agregado!!';
      case 14:
        return 'Configuración Editado!!';
      case 12:
        return 'Configuración Dado de Baja!!';
      case 11:
        return 'Configuración Dado de Alta!!';
      default:
        return '¡Listo!';
    }
  };
